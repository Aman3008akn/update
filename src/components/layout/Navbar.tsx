  ...
  return (
    <nav className="sticky top-0 z-40 bg-paper border-b-2 border-black shadow-sm mt-0 pt-0">
            ...
            <Sheet>
              ...
              <SheetContent className="bg-paper border-l-2 border-black">
                <div className="flex flex-col space-y-6 mt-8">
                  ...
                  <Link to="/catalog/tech-gadgets" className="text-xl font-heading font-bold text-foreground hover:text-primary transition-colors">
                    Tech Gadgets
                  </Link>
                  <Link to="/catalog/apparel" className="text-xl font-heading font-bold text-foreground hover:text-primary transition-colors">
                    Apparel
                  </Link>
                  <Link to="/catalog/mystery-boxes" className="text-xl font-heading font-bold text-foreground hover:text-primary transition-colors">
                    🎁 Mystery Boxes
                  </Link>
      ...
      <div className="hidden md:block border-t-2 border-black bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-6 h-12 text-sm font-heading font-bold tracking-wide uppercase overflow-x-auto scrollbar-hide">
            <Link to="/catalog/figurines" className="text-foreground hover:text-primary hover:underline decoration-2 underline-offset-4 transition-all whitespace-nowrap">
              Figurines
            </Link>
            <Link to="/catalog/manga" className="text-foreground hover:text-primary hover:underline decoration-2 underline-offset-4 transition-all whitespace-nowrap">
              Manga
            </Link>
            <Link to="/catalog/posters" className="text-foreground hover:text-primary hover:underline decoration-2 underline-offset-4 transition-all whitespace-nowrap">
              Posters
            </Link>
            <Link to="/catalog/accessories" className="text-foreground hover:text-primary hover:underline decoration-2 underline-offset-4 transition-all whitespace-nowrap">
              Accessories
            </Link>
            <Link to="/catalog/tech-gadgets" className="text-foreground hover:text-primary hover:underline decoration-2 underline-offset-4 transition-all whitespace-nowrap">
              Tech Gadgets
            </Link>
            <Link to="/catalog/apparel" className="text-foreground hover:text-primary hover:underline decoration-2 underline-offset-4 transition-all whitespace-nowrap">
              Apparel
            </Link>
            <Link to="/support" className="text-foreground hover:text-primary hover:underline decoration-2 underline-offset-4 transition-all whitespace-nowrap">
              Support
            </Link>
            <Link to="/catalog/mystery-boxes" className="text-secondary-foreground hover:text-accent hover:underline decoration-2 underline-offset-4 transition-all flex items-center whitespace-nowrap">
