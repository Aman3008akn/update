...
export default function HeroBannerCarousel() {
  ...
  const isDisabled = settings.hero_banner_enabled === false || settings.hero_enabled === false;
  ...
  useEffect(() => {
    if (!autoRotate || isDisabled) return;
  ...
  }, [availableBanners.length, rotationInterval, autoRotate, isDisabled]);

  // If hero banner is disabled in settings, don't render (after all hooks)
  if (isDisabled) {
    return null;
  }
